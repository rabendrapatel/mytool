...
export class HandyFormComponent implements OnInit, OnDestroy, AfterContentInit {
  ...
  @Input() public disableEnterSubmit: boolean = true;
  @Input() public resetFormStateOnSubmit: boolean = true;
  @Input() public showErrorsOnInvalidSubmit: boolean = true;
  ...
  private emitSubmitEvents(): void {
    ...
    if (invalidInputs && invalidInputs.length > 1) {
      ...
      let invalidInput: HTMLInputElement = (<HTMLInputElement>invalidInputs[1]);
