...
import { Component, Optional, Self, OnInit, OnDestroy, Input, ViewChild, ElementRef, Injector, Output, EventEmitter } from '@angular/core';
...
export class HandyDateInputComponent extends HandyFormControl implements ControlValueAccessor, OnInit, OnDestroy {
  ...
  @Output('open') public open: EventEmitter<void> = new EventEmitter();
  @Output('close') public close: EventEmitter<void> = new EventEmitter();
