...
@Component({
  selector: 'handy-bar-chart',
  templateUrl: './handy-bar-chart.component.html',
  styleUrls: ['./handy-bar-chart.component.scss']
})
export class HandyBarChartComponent implements OnInit, AfterContentInit, OnDestroy {
  ...
  private __setChartInstance(): void {
    ...
    this.chart = new this.google.visualization.BarChart(document.getElementById(this.randomId));
